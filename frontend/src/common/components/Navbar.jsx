  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${
        isScrolled
          ? 'py-3 bg-[#0a0d14]/80 backdrop-blur-md border-b border-slate-800/80 shadow-lg shadow-cyan-950/10'
          : 'py-5 bg-transparent'
      }`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <NavLink to="/" className="flex items-center gap-2 group">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-cyan-500 to-blue-600 flex items-center justify-center text-black font-extrabold text-xl shadow-lg shadow-cyan-500/20 group-hover:scale-105 transition-transform">
            SK
          </div>
          <span className="text-xl font-bold bg-gradient-to-r from-slate-100 via-slate-200 to-cyan-400 bg-clip-text text-transparent">
        ...
        <div className="hidden lg:flex items-center gap-3">
          ...
          <NavLink
            to="/admin/login"
            className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-slate-800/60 hover:bg-slate-700/80 text-xs font-semibold text-slate-300 border border-slate-700/60 hover:border-cyan-500/40 transition-all"
          >
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="lg:hidden bg-[#0a0d14]/95 backdrop-blur-xl border-b border-slate-800 px-4 py-6"
          >
