...
export function Footer() {
  ...
  return (
    <footer className="relative z-10 border-t border-slate-200/80 dark:border-slate-800/80 bg-[#07090e]/90 pt-12 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-10 border-b border-slate-200/60 dark:border-slate-800/60">
          ...
          <div className="md:col-span-2 space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold text-slate-900 dark:text-slate-100">Sathish Kumar</span>
            </div>
          ...
          <div className="space-y-3">
            <h4 className="text-sm font-semibold text-slate-800 dark:text-slate-200 tracking-wider uppercase">Navigation</h4>
          ...
          {/* Social Links */}
          <div className="space-y-3">
            <h4 className="text-sm font-semibold text-slate-800 dark:text-slate-200 tracking-wider uppercase">Connect</h4>
            <div className="flex items-center gap-3">
              <a
                href="https://github.com/sathishkumar"
                target="_blank"
                rel="noreferrer"
                className="p-2.5 rounded-xl glass-card text-slate-600 dark:text-slate-400 hover:text-cyan-400 hover:border-cyan-500/40 transition-colors"
        ...
        {/* Bottom Bar */}
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-600 dark:text-slate-400">
          ...
          <button
            onClick={scrollToTop}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg glass-card hover:border-cyan-500/40 text-slate-700 dark:text-slate-300 hover:text-cyan-400 transition-colors"
          >
