    ...
    <div className="min-h-[75vh] flex items-center justify-center px-4 py-12">
      ...
      >
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-black text-slate-900 dark:text-slate-100">Admin Portal</h1>
          <p className="text-xs text-slate-600 dark:text-slate-400">Enter JWT credentials to manage portfolio content</p>
        </div>
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                placeholder="admin"
                className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-slate-100 text-sm focus:outline-none focus:border-cyan-500"
              />
            </div>
          </div>
