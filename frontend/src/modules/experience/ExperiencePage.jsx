  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
      ...
      <div className="text-center max-w-3xl mx-auto space-y-4">
        ...
        <h1 className="text-4xl font-extrabold text-slate-900 dark:text-slate-100">Work Experience</h1>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          {experiences.map((exp) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="glass-card p-8 rounded-3xl border border-slate-200 dark:border-slate-800 hover:border-cyan-500/40 transition-all space-y-6"
            >
              ...
              <div className="space-y-3">
                <h4 className="text-xs font-bold uppercase tracking-wider text-slate-700 dark:text-slate-300">Key Achievements & Impact</h4>
              ...
              <div className="flex flex-wrap gap-2 pt-2">
                {exp.technologies.map((tech) => (
                  <span key={tech} className="px-3 py-1 rounded-lg text-xs bg-slate-200/80 dark:bg-slate-800/80 text-cyan-300 border border-slate-300 dark:border-slate-700">
                    {tech}
                  </span>
                ))}
              </div>
