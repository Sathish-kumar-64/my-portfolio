  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10">
      ...
      <div className="text-center max-w-3xl mx-auto space-y-4">
        ...
        <h1 className="text-4xl font-extrabold text-slate-100">Articles & Blog</h1>
      ...
      <div className="max-w-md mx-auto relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-slate-900/80 border border-slate-700/60 text-slate-100 placeholder-slate-500 text-sm focus:outline-none focus:border-cyan-500"
        />
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredBlogs.map((blog) => (
            <motion.div
              key={blog.id}
              whileHover={{ y: -4 }}
              className="glass-card p-6 rounded-2xl border border-slate-800 hover:border-cyan-500/40 transition-all flex flex-col justify-between cursor-pointer group"
              onClick={() => {
            ...
            >
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {blog.tags?.map((tag) => (
                    <span key={tag} className="px-2 py-0.5 rounded text-xs bg-slate-800 text-slate-400 flex items-center gap-1">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-md">
            ...
            >
              <button
                ...
                className="absolute top-6 right-6 px-3 py-1.5 rounded-xl glass-card text-xs font-semibold text-slate-400 hover:text-slate-100"
              >
                Close
              </button>
              ...
              <div className="space-y-3">
                ...
                <h2 className="text-3xl font-black text-slate-100 leading-tight">{activeBlogModal.title}</h2>
              ...
              <div className="pt-8 border-t border-slate-800 space-y-6">
                ...
                <div className="space-y-3">
                  {activeBlogModal.comments?.map((c) => (
                    <div key={c.id} className="p-4 rounded-xl glass-card border border-slate-800/80 space-y-1">
                ...
                {/* Add Comment Form */}
                <form onSubmit={handleCommentSubmit} className="glass-card p-4 rounded-2xl border border-slate-800 space-y-3">
                  <h4 className="text-xs font-bold uppercase tracking-wider text-slate-200">Leave a Comment</h4>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <input
                      ...
                      required
                      className="px-3.5 py-2 rounded-xl bg-slate-900 border border-slate-800 text-slate-100 text-xs focus:outline-none focus:border-cyan-500"
                    />
                    <input
                      type="email"
