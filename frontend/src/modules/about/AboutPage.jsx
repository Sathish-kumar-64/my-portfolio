  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
      ...
      <div className="text-center max-w-3xl mx-auto space-y-4">
        ...
        <h1 className="text-4xl font-extrabold text-slate-900 dark:text-slate-100">About Me</h1>
      ...
      <div className="space-y-8 max-w-4xl mx-auto">
        <div className="flex items-center gap-3 border-b border-slate-200 dark:border-slate-800 pb-4">
          ...
          <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Career Journey & Education</h2>
        </div>

        <div className="relative border-l-2 border-slate-200 dark:border-slate-800 ml-4 pl-6 space-y-10">
          {milestones.map((item, index) => (
            ...
            >
              {/* Timeline Dot */}
              <div className="absolute -left-[31px] top-1.5 w-4 h-4 rounded-full bg-slate-100 dark:bg-slate-900 border-2 border-cyan-400 group-hover:bg-cyan-400 transition-colors" />

              <div className="glass-card p-6 rounded-2xl border border-slate-200 dark:border-slate-800 hover:border-cyan-500/40 transition-all space-y-2">
                <span className="text-xs font-semibold px-3 py-1 rounded-full bg-cyan-500/10 text-cyan-400 border border-cyan-500/20">
                  {item.year}
                </span>
                <h3 className="text-xl font-bold text-slate-900 dark:text-slate-100 pt-1">{item.title}</h3>
      ...
      <div className="max-w-4xl mx-auto glass-panel p-8 rounded-3xl border border-cyan-500/20 space-y-4">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Career Goals & Vision</h2>
        </div>
